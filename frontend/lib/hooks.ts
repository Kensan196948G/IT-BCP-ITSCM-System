...
import { systems, exercises, incidents, dashboard, procedures, contacts, biaApi, scenariosApi } from "./api";
import type {
  ITSystemBCP,
  BCPExercise,
  ActiveIncident,
...
export function useScenarios(): UseApiResult<BCPScenario[]> {
  return useApi(() => scenariosApi.list());
}
