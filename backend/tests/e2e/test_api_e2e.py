...
class TestAuthE2E:
    ...
    def test_login_returns_token(self, page: Any, base_url: str) -> None:
    ...
    def test_login_invalid_role_returns_422(self, page: Any, base_url: str) -> None:
    ...
    def test_me_requires_auth(self, page: Any, base_url: str) -> None:
        """GET /api/auth/me without token returns 401."""
        resp = page.request.get(f"{base_url}/api/auth/me")
        assert resp.status == 401

    def test_me_returns_user_info(self, page: Any, base_url: str, auth_headers: dict[str, Any]) -> None:
    ...
    def test_refresh_returns_new_token(self, page: Any, base_url: str, auth_headers: dict[str, Any]) -> None:
...
class TestHealthE2E:
    ...
    def test_health_returns_200(self, page: Any, base_url: str) -> None:
    ...
    def test_liveness_probe(self, page: Any, base_url: str) -> None:
        resp = page.request.get(f"{base_url}/api/health/live")
        assert resp.status == 200
        assert resp.json()["status"] == "alive"

    def test_readiness_probe(self, page: Any, base_url: str) -> None:
...
class TestProtectedEndpointsE2E:
    ...
    def test_returns_401_without_token(self, page: Any, base_url: str, path: str) -> None:
    ...
    @pytest.mark.parametrize("path", PROTECTED_GET)
    def test_returns_non_401_with_token(self, page: Any, base_url: str, path: str, auth_headers: dict[str, Any]) -> None:
...
class TestSecurityHeadersE2E:
    ...
    def test_health_response_has_security_headers(self, page: Any, base_url: str) -> None:
