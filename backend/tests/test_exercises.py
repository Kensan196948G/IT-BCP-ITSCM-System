...
def test_list_exercises(mock_get_all: AsyncMock, _sc: AsyncMock, _gc: AsyncMock, client: TestClient) -> None:
...
@patch("apps.routers.exercises.set_cached", new_callable=AsyncMock)
@patch("apps.crud.get_all_exercises", new_callable=AsyncMock)
def test_list_exercises_empty(mock_get_all: AsyncMock, _sc: AsyncMock, _gc: AsyncMock, client: TestClient) -> None:
...
@patch("apps.crud.get_all_exercises", new_callable=AsyncMock)
def test_list_exercises_cache_hit(mock_get_all: AsyncMock, mock_gc: AsyncMock, client: TestClient) -> None:
...
def test_create_exercise(mock_create: AsyncMock, mock_inv: AsyncMock, client: TestClient) -> None:
...
def test_create_exercise_invalid_type(client: TestClient) -> None:
...
def test_get_exercise(mock_get: AsyncMock, client: TestClient) -> None:
...
@patch("apps.crud.get_exercise", new_callable=AsyncMock)
def test_get_exercise_not_found(mock_get: AsyncMock, client: TestClient) -> None:
...
def test_update_exercise(mock_update: AsyncMock, mock_inv: AsyncMock, client: TestClient) -> None:
...
@patch("apps.crud.update_exercise", new_callable=AsyncMock)
def test_update_exercise_not_found(mock_update: AsyncMock, client: TestClient) -> None:
...
@patch("apps.crud.get_all_exercises", new_callable=AsyncMock)
def test_export_exercises_csv(mock_get_all: AsyncMock, client: TestClient) -> None:
...
@patch("apps.crud.get_all_exercises", new_callable=AsyncMock)
def test_export_exercises_csv_empty(mock_get_all: AsyncMock, client: TestClient) -> None:
