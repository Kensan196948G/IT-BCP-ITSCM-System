...
class TestRunbookEndpoints:
    ...
    def test_get_deployment_checklist(self, client: TestClient) -> None:
    ...
    def test_get_rollback_procedure(self, client: TestClient) -> None:
    ...
    def test_get_dr_failover(self, client: TestClient) -> None:
    ...
    def test_get_incident_playbook_earthquake(self, client: TestClient) -> None:
    ...
    def test_get_incident_playbook_ransomware(self, client: TestClient) -> None:
    ...
    def test_get_incident_playbook_dc_failure(self, client: TestClient) -> None:
    ...
    def test_get_incident_playbook_unknown_returns_404(self, client: TestClient) -> None:
        resp = client.get("/api/runbook/incident-playbook/unknown_scenario")
        assert resp.status_code == 404
        data = resp.json()
        assert "detail" in data

    def test_deployment_checklist_categories(self, client: TestClient) -> None:
        resp = client.get("/api/runbook/deployment-checklist")
        data = resp.json()
    ...
    def test_playbook_step_counts_parametrized(self, client: TestClient, scenario: str, expected_steps: int) -> None:
