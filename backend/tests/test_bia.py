...
def _fake_db() -> Callable[[], AsyncGenerator[AsyncMock, None]]:
...
class TestCalculateRiskScore:
    ...
    def test_high_financial_impact(self) -> None:
...
class TestRiskMatrix:
    ...
    def test_skips_assessment_with_none_risk_score(self) -> None:
    ...
    def test_risk_matrix_with_dict_assessments(self) -> None:
